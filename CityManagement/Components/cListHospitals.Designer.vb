...
Partial Class cListHospitals
    ...
    Private Sub InitializeComponent()
        ...
        ' Guna2TileButton1
        ' 
        Guna2TileButton1.BackColor = Color.WhiteSmoke
        Guna2TileButton1.BorderColor = Color.Gainsboro
        Guna2TileButton1.BorderStyle = Drawing2D.DashStyle.Dash
        ...
        ' Guna2TextBox2
        ' 
        Guna2TextBox2.BackColor = Color.SkyBlue
