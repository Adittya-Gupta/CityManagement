...
Partial Class EducationOwner
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(EducationOwner))
        Label7 = New Label()
        Panel1 = New Panel()
        Label6 = New Label()
        Label5 = New Label()
        ...
        Label7.Location = New Point(834, 45)
        Label7.Name = "Label7"
        ...
        Label6.Location = New Point(322, 45)
        Label6.Name = "Label6"
        Label6.Padding = New Padding(5)
        Label6.Size = New Size(352, 68)
        Label6.TabIndex = 38
        Label6.Text = "Education Owner"
        Label6.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' Label5
        ' 
        Label5.Location = New Point(295, 3)
        Label5.Name = "Label5"
        ...
        ' Label4
        ' 
        Label4.Location = New Point(275, 3)
        Label4.Name = "Label4"
        ...
        ' Label3
        ' 
        Label3.Location = New Point(158, 3)
        Label3.Name = "Label3"
        Label3.Size = New Size(139, 20)
        Label3.TabIndex = 35
        Label3.Text = "Education Owner"
        ' 
        ' Label2
        ' 
        Label2.Location = New Point(135, 3)
        Label2.Name = "Label2"
