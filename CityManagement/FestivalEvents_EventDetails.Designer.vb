...
Partial Class FestivalEvents_EventDetails
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FestivalEvents_EventDetails))
        Label2 = New Label()
        Label1 = New Label()
        ...
        ' TextBox1
        ' 
        TextBox1.Location = New Point(670, 500)
        TextBox1.Multiline = True
        TextBox1.Name = "TextBox1"
        TextBox1.Size = New Size(500, 300)
        TextBox1.TabIndex = 0
        ' 
        ' Label3
        ' 
        ...
        Panel1.Font = New Font("Microsoft Sans Serif", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
