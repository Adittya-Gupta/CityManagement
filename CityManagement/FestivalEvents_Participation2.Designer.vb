...
Partial Class FestivalEvents_Participation2
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FestivalEvents_Participation2))
        Panel2 = New Panel()
        Label2 = New Label()
        Panel1 = New Panel()
        Label9 = New Label()
        ...
        Label2.Location = New Point(247, 52)
        ...
        Label9.Location = New Point(623, 266)
        Label9.Name = "Label9"
        Label9.Size = New Size(151, 35)
        Label9.TabIndex = 15
        ...
        Label7.Location = New Point(623, 231)
        Label7.Name = "Label7"
        Label7.Size = New Size(216, 35)
        Label7.TabIndex = 14
        ...
        Label3.Location = New Point(623, 196)
        Label3.Name = "Label3"
        ...
        maxage.Location = New Point(830, 231)
        maxage.Name = "maxage"
        maxage.Size = New Size(203, 35)
        maxage.TabIndex = 12
        ...
        capacity.Location = New Point(780, 266)
        capacity.Name = "capacity"
        capacity.Size = New Size(140, 35)
        ...
        minage.Location = New Point(830, 196)
        minage.Name = "minage"
        minage.Size = New Size(201, 35)
        minage.TabIndex = 10
        minage.Text = "Minimum Age :"
        ' 
        ' Label5
        ' 
        Label5.Font = New Font("Abhaya Libre Medium", 18F, FontStyle.Bold)
        Label5.Location = New Point(623, 301)
        Label5.Name = "Label5"
        Label5.Size = New Size(408, 30)
        Label5.TabIndex = 9
        Label5.Text = "Description"
        ' 
        ' Description
        ' 
        Description.Font = New Font("Abhaya Libre Medium", 18F)
        Description.Location = New Point(623, 342)
        Description.Name = "Description"
        Description.Size = New Size(408, 129)
        ...
        Button1.Location = New Point(658, 474)
        ...
        EventTime.Location = New Point(839, 161)
        ...
        Label8.Location = New Point(623, 161)
        Label8.Name = "Label8"
        ...
        EventDate.Location = New Point(833, 126)
        ...
        Label6.Location = New Point(623, 126)
        Label6.Name = "Label6"
        ...
        EventVenue.Location = New Point(742, 91)
        ...
        Label4.Location = New Point(623, 91)
        Label4.Name = "Label4"
        ...
        EventName.Location = New Point(614, 36)
        ...
        Name = "FestivalEvents_Participation2"
        Text = "FestivalEvents_Participation2"
