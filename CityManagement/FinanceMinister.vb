...
Public Class FinanceMinister
    ...
    Private Sub LoadMinisterRequests()
        ...
        Try
            ...
            cmd.CommandText = "SELECT mr.SID, u.Name, u.ProfilePic, mr.Date, mr.details, mr.Status FROM minister_req mr JOIN User u ON mr.SID = u.SID WHERE mr.Ministry = 'Finance' AND mr.Status = " & statusFilter
