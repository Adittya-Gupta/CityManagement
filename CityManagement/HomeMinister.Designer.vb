...
Partial Class HomeMinister
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(HomeMinister))
        Label3 = New Label()
        Label2 = New Label()
        Label1 = New Label()
        Panel1 = New Panel()
        ...
        Label2.Location = New Point(179, 88)
        Label2.Name = "Label2"
        Label2.Size = New Size(543, 48)
        Label2.TabIndex = 8
        Label2.Text = "Home Minister"
        ...
        Label1.Location = New Point(777, 45)
        Label1.Name = "Label1"
