...
Public Class HomeMinister
    ...
    Private Sub HomeMinister_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadMinisterRequests()
        ...
        Try
            ...
            cmd.CommandText = "SELECT mr.SID, u.Name, u.ProfilePic, mr.Date, mr.details, mr.Status FROM minister_req mr JOIN User u ON mr.SID = u.SID WHERE mr.Ministry = 'Home' AND mr.Status = " & statusFilter
