...
Partial Class MuncipalOffice
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MuncipalOffice))
        Label7 = New Label()
        Panel1 = New Panel()
        Label6 = New Label()
        Label5 = New Label()
        ...
        Label6.TabIndex = 29
        Label6.Text = "Muncipal Officer"
        Label6.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' Label5
        ' 
        Label5.Location = New Point(295, 6)
        Label5.Name = "Label5"
