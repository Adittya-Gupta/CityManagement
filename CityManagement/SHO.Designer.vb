...
Partial Class SHO
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SHO))
        Label7 = New Label()
        Panel1 = New Panel()
        Label6 = New Label()
        Label5 = New Label()
        ...
        ' Label5
        ' 
        Label5.Location = New Point(206, 6)
        Label5.Name = "Label5"
        ...
        ' Label4
        ' 
        Label4.Location = New Point(195, 6)
        Label4.Name = "Label4"
