...
Public Class TransportMinister

    Private isPendingView As Boolean = False ' Flag to track if pending view is active

    Private Sub TransportMinister_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadMinisterRequests()
        ...
        Try
            ...
            cmd.CommandText = "SELECT mr.SID, u.Name, u.ProfilePic, mr.Date, mr.details, mr.Status FROM minister_req mr JOIN User u ON mr.SID = u.SID WHERE mr.Ministry = 'Transport' AND mr.Status = " & statusFilter
