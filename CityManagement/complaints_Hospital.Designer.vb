...
Partial Class complaints_Hospital
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(complaints_Hospital))
        Label3 = New Label()
        Panel2 = New Panel()
        Panel3 = New Panel()
        Panel1 = New Panel()
