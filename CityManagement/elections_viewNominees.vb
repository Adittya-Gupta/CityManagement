...
Public Class elections_viewNominees
        ...
        Using conn As New MySqlConnection(connString)
            Try
                ...
                While reader.Read()
                    ...
                    Dim ucNominee As New elections_UCNominees()
    ...
    Private Sub viewNominees_Load(sender As Object, e As EventArgs) Handles MyBase.Load
