...
Public Class student_dashboard
    ...
    Private Sub student_dashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.AutoScroll = True
            Me.HorizontalScroll.Maximum = 11000
                    ...
                    While reader.Read()
                        If Convert.ToDouble(reader("no_of_sec_completed")) = Convert.ToDouble(reader("sections")) Then
                            ...
                            Sub()
                                ...
                                Dim form_1 As New certificate()
                                form_1.SetUserName(s3)
                                form_1.SetInstName(s2)
                                form_1.SetcourcetName(s1)
                                form_1.SetUserID(userid)
                                form_1.Show()
                                Me.Hide()
                ...
                Using reader As MySqlDataReader = command.ExecuteReader()
                    ...
                    While reader.Read()
                        If (Convert.ToDouble(reader("paymemt_status"))) = 0 Then
                            ...
                            groupBox.Controls.Add(picturebox)
                            groupBox.Controls.Add(label)
                            groupBox.Location = New Point((count2 Mod 6) * 220 + 48, Int(count2 / 6) * 250 + h + 155)
