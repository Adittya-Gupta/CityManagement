...
Public Class Banking_LoanManagement
    ...
    Private Sub Banking_LoanManagement_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        updateTable()
    End Sub
